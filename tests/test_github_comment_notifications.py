...
def test_fetcher_combines_paginated_issue_and_pr_review_comments() -> None:
    ...
    def runner(
        ...
        if any(part.endswith("issues/comments") for part in command):
            stdout = """[[{"id":101,"issue_url":"https://api.github.com/repos/o/r/issues/42","html_url":"https://github.com/o/r/issues/42#issuecomment-101","user":{"login":"ops"},"created_at":"2026-07-29T04:01:00Z","body":"issue update"}],[]]"""
        else:
