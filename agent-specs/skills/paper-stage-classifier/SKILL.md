...
| garch-x-vix | **review** | 36p, 25 cites (Paper 9)，{{GUIDE_FILE}} 標 main thread |
...
{{GUIDE_FILE}}「論文更新標準程序」段已提此 SOP 大綱（行 ~221）。本 skill 提供完整實作細節 + ready-for-submission continuous loop 規範。{{GUIDE_FILE}} 不重複內容，只 reference 此 skill。
