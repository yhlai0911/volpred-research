...
### 4. 孤兒 worktree 清理
```bash
# 檢查 {{PROVIDER_DIR}}/worktrees/ 中沒有 .git 的目錄
for d in {{PROVIDER_DIR}}/worktrees/agent-*; do
...
| 2026-03 | 85/124 實驗不在 knowledge.json | N/A | 只存 results JSON 不進知識庫 | {{GUIDE_FILE}} 強制規定三項產出 |
