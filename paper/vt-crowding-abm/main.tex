...
The performance differences are statistically significant. Using Welch's $t$-test on the 500 simulation-level Sharpe ratios, the 10\% versus 30\% comparison yields $t = 3.64$ ($p < 0.001$), marginally exceeding the \citet{harvey2016} threshold of $t > 3.0$ for claiming statistical significance in asset pricing. The degradation at 50\% versus 10\% yields $t = 17.82$ ($p < 0.001$), far exceeding this threshold. The 10\% versus 30\% difference, while statistically significant, is economically small (Sharpe 0.47 vs.\ 0.47); the economically meaningful transition occurs between 30\% and 50\%.
