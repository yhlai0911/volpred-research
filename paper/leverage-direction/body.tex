...
We estimate the asymmetry parameter $\gamma$ of GJR-GARCH(1,1) using a rolling window of 504 trading days, updating quarterly. Table~\ref{tab:gamma} reports cross-sectional statistics for each asset.
