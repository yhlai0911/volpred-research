...
TLT is consistent with its near-zero $\gamma$: the two models are statistically indistinguishable in both periods, with GARCH marginally ahead in 2023--2024 ($\Delta = +0.20\%$, $p = 0.238$) and GJR marginally ahead in 2025 ($\Delta = -0.33\%$, $p = 0.133$).% source: experiments/k903/tables/k903_table3.csv TLT rows (audit fix 2026-06-11: earlier draft carried pre-K903 vintage figures with the opposite 2023--2024 direction)
