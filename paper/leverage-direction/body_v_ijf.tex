...
%   [tick-2+ TODO] Port Literature Review from body.tex:23-27, reframe the
%            third strand around forecast-evaluation / complexity, not taxonomy.
...
% [TICK-2 TODO] Port from body.tex:23-27. Reframe the third strand: lead the
% forecast-EVALUATION / complexity-cost literature (Patton loss, DM/MCS,
% honest OOS), then risk mgmt, then VT. Position leverage-direction taxonomy
% as interpretive, not as the gap being filled.
