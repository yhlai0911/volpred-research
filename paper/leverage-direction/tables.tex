...
\multicolumn{7}{l}{\textit{Student-$t$ restores compliance; historical simulation is a promising nonparametric}} \\
\multicolumn{7}{l}{\textit{alternative pending further validation of the Student-$t$ benchmark specification.}} \\
\bottomrule
\end{tabular}
\end{table}
