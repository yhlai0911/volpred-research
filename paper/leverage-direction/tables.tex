...
\multicolumn{7}{l}{\textit{Historical simulation (empirical quantile of standardized residuals) achieves the}} \\
\multicolumn{7}{l}{\textit{lowest violation rate without any distributional assumption (K824).}} \\
\bottomrule
\end{tabular}
\end{table}
