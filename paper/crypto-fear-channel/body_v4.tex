...
% body_v4.tex: §1-§5 carry-over from body_v3.tex 2026-04-28 +
%              §6 Robustness + §7 OOS forecasting (NEW, drafted 2026-04-28 main thread)
...
The Diebold-Mariano test under squared-error loss returns $t = -0.98$ with $p = 0.33$, both well below the \citet{harvey2016} $|t| > 3$ threshold for newly proposed predictors and even below the conventional $|t| > 1.96$ benchmark.% source: experiments/k1025/k1025_results.json .forecast_evaluation
