...
\paragraph{Asymmetry.} Using the asymmetric Granger-causality framework of \citet{hatemi2012}, we separate Bitcoin positive and negative realized volatility and test whether each Granger-causes VIX over lags 1 through 10. We find that the negative branch carries the entire spillover: Bitcoin downside volatility Granger-causes VIX at conventional lags, while the upside branch is uniformly non-significant. This is not merely a statistical artifact of a leverage effect --- the asymmetry survives standard symmetric Granger tests as well. Our interpretation is behavioral: retail-heavy crypto markets transmit \emph{fear}, not \emph{euphoria}, into the institutional equity complex.

\paragraph{Tail concentration.} Quantile regressions of VIX on BTC realized variance show that the slope coefficient is essentially flat at low-to-median quantiles (2.61 at $\tau = 0.5$) but rises steeply at upper quantiles (22.31 at $\tau = 0.95$), an $8.5\times$ amplification. The spillover is therefore not a uniform channel but a \emph{tail-conditional} phenomenon. Conventional OLS or DCC-GARCH estimates --- which implicitly weight all observations equally --- systematically understate the crisis-time impact of crypto volatility on equity fear.
...
\newblock Bitcoin, gold, and commodities as safe havens for stocks.
\newblock {\em Finance Research Letters}, 37:101764.
