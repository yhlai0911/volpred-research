...
\midrule
Asymmetric Granger BTC$^-$ best $F$ (lags 1--5)        & 18.96 (lag 1) & 24.31 (lag 1) \\
Asymmetric Granger BTC$^+$ p (all lags 1--5)            & 0.16--0.95 (NS) & 0.14+ (NS) \\
QR $\beta_{0.05}$                                       & $-2.86$ & $-1.46$ \\
QR $\beta_{0.5}$                                        & $+2.61$ & $+2.83$ \\
QR $\beta_{0.95}$                                       & $+22.31$ & $+16.29$ \\
QR upper-tail amplification ($\beta_{0.95}/\beta_{0.5}$) & $8.54\times$ & $5.76\times$ \\
