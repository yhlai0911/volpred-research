...
\begin{equation}
    ...
    \label{eq:sessions}
\end{equation}
and the common evaluation target for all models is the full-day variance proxy $\sigma^2_{\text{full},d} = r^2_{d,0} + r^2_{d,1}$, a whole-day variance assembled from session components in the spirit of \citet{HansenLunde2005}. Under QLIKE loss, model rankings are robust to noise in unbiased proxies \citep{Patton2011,Hansen2006}. For TAIFEX, tick-level 5-minute realized variances replace squared session returns.
...
\paragraph{Robustness.} The close-time null is robust to how the unobserved overnight square is plugged in: a lagged-realized variant ($z = r^2_{d-1,0}$) reproduces the verdict in every market---nothing approaches the conservative threshold in either variant, and the near-zero 0050.TW cell flips sign across variants ($+0.32$ vs.\ $-0.28$), exactly as statistical noise should.
...
\newblock \url{https://doi.org/10.1016/S0927-5398(97)00004-2}
...
\newblock A realized variance for the whole day based on intermittent high-frequency data.
\newblock \emph{Journal of Financial Econometrics}, 3(4), 525--554.
\newblock \url{https://doi.org/10.1093/jjfinec/nbi028}
...
\bibitem[Tsiakas(2008)]{Tsiakas2008}
Tsiakas, I. (2008).
\newblock Overnight information and stochastic volatility: A study of European and US stock exchanges.
\newblock \emph{Journal of Banking \& Finance}, 32(2), 251--268.
\newblock \url{https://doi.org/10.1016/j.jbankfin.2007.03.008}
