...
Over the out-of-sample period 2020--2026 (1,501 trading days), the GJR-GARCH + Student-$t$(5) VaR produces 8 violations (0.5\%), within the Basel III Green Zone threshold of 1.0\% (noting that the traffic-light framework is defined for 250-day windows; we apply the 1\% threshold as a benchmark across our full sample).\footnote{For the extended OOS period 2019--2026 ($n = 1{,}756$; K896), GJR+Student-$t$ produces 18 violations (1.025\%), which still passes the Kupiec test at $\alpha = 0.05$ ($p = 0.86$). The lower violation count over 2020--2026 reflects the exclusion of the higher-volatility 2019 period from the strategy evaluation window.} The \citet{kupiec1995} likelihood ratio test does not reject correct unconditional coverage ($p = 0.12$). For comparison, the Normal distribution produces 30 violations (2.0\% over 2020--2026; full OOS 2019--2026 rate: 1.71\%, K896), a borderline result that would trigger the Yellow Zone under Basel III.
