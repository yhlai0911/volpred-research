...
Lagged own return (AR1) & 0.999 & 0.087 \\
...
% Transition: Sections 2-4 relied on daily squared returns as the volatility proxy.
% Section 5 challenges this foundation using intraday tick data from TAIFEX.
