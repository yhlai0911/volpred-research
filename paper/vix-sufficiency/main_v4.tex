...
We address this gap by conducting the first comprehensive, pre-registered horse race among thirteen signal families, evaluated under a unified framework with six methodological safeguards:
...
\begin{enumerate}[label=(\roman*)]
    ...
    \item \textbf{Multiple-testing control}: We adopt the approximate conservative threshold of $|t| > 3.0$ motivated by \citet{harvey2016} and implement formal Holm-Bonferroni sequential correction across all Diebold-Mariano tests in the pre-registered family set, controlling the family-wise error rate at $\alpha = 0.05$.
