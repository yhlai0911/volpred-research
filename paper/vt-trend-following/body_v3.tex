...
Table~\ref{tab:international} extends our analysis to 13 international equity markets, using a pinned-data, monthly-rebalanced, cost-inclusive protocol (experiment K1695; see table notes). The results support the ``insurance pricing'' interpretation of VT. All 13 markets see a positive MDD improvement under the 12/VIX overlay --- a descriptive regularity, with formal inference conducted on the 13-market common sample ($N = 3{,}557$ shared trading dates): the common-sample average reduction is 12.6 percentage points, with a joint stationary-bootstrap 90\% confidence interval of $[4.2, 19.3]$ pp that excludes zero ($\Pr(\Delta\text{MDD} \le 0) = 0.0006$). Over each market's full inception-aware history the average reduction is larger (27.5 pp), because the common sample excludes the 2008--2009 crisis for most markets. The effect spans developed and emerging markets: Brazil (EWZ), with the deepest base-case MDD of $-$77.3\%, sees the smallest reduction (9.9 pp), while the UK (EWU), with MDD of $-$64.0\%, achieves a 33.5 pp reduction.

In contrast, only 1 of 13 markets shows a Sharpe ratio improvement (EWJ, marginal at $+0.009$). The average Sharpe change is $-$0.044, confirming that VT acts as insurance rather than alpha generation: investors pay a return premium (average annual return cost 1.2 pp after 10 bps turnover costs) for drawdown protection.

The cross-sectional pattern is consistent with VIX sensitivity (the correlation between an asset's daily returns and VIX changes) tracking the magnitude of MDD protection: Pearson $r = -0.817$ ($p < 0.001$), Spearman $\rho = -0.775$ ($p = 0.002$). This is a descriptive cross-sectional association, not a causal claim. Markets that are more negatively correlated with VIX (i.e., more ``risk-off'' sensitive) benefit more from the VIX overlay.

Developed markets receive stronger inception-aware MDD protection than emerging markets (average 31.3 pp vs.\ 23.0 pp), reflecting their tighter synchronization with US equity market conditions. This is consistent with \citet{rapach2013}, who document that the US market leads international returns, and with the global financial cycle literature~\citep{miranda2020}.
...
% source: experiments/k1695/table5_rows.csv (inception-aware rows; pinned snapshot)
EFA (EAFE) & $-$0.654 & 0.243 & $-$61.0 & 0.211 & $-$28.3 & $-$0.032 & 32.8 \\
EWJ (Japan) & $-$0.576 & 0.215 & $-$53.5 & 0.224 & $-$24.0 & 0.009 & 29.5 \\
EWG (Germany) & $-$0.606 & 0.240 & $-$63.1 & 0.205 & $-$33.5 & $-$0.034 & 29.6 \\
EWU (UK) & $-$0.610 & 0.210 & $-$64.0 & 0.160 & $-$30.5 & $-$0.050 & 33.5 \\
EWA (Australia) & $-$0.587 & 0.275 & $-$67.0 & 0.176 & $-$34.0 & $-$0.098 & 33.0 \\
EWC (Canada) & $-$0.588 & 0.321 & $-$60.8 & 0.295 & $-$33.6 & $-$0.026 & 27.1 \\
VGK (Europe) & $-$0.640 & 0.252 & $-$63.7 & 0.212 & $-$29.9 & $-$0.040 & 33.8 \\
\midrule
\multicolumn{8}{@{}l}{\textit{Panel B: Emerging Markets}} \\
EEM (EM Broad) & $-$0.600 & 0.233 & $-$66.4 & 0.174 & $-$32.1 & $-$0.059 & 34.3 \\
FXI (China) & $-$0.493 & 0.179 & $-$72.7 & 0.131 & $-$47.4 & $-$0.048 & 25.3 \\
EWZ (Brazil) & $-$0.505 & 0.234 & $-$77.3 & 0.173 & $-$67.4 & $-$0.061 & 9.9 \\
INDA (India) & $-$0.467 & 0.267 & $-$45.1 & 0.191 & $-$26.1 & $-$0.076 & 19.0 \\
EWT (Taiwan) & $-$0.569 & 0.411 & $-$62.9 & 0.375 & $-$31.7 & $-$0.036 & 31.2 \\
MCHI (China Broad) & $-$0.468 & 0.169 & $-$62.8 & 0.148 & $-$44.3 & $-$0.021 & 18.5 \\
\midrule
% source: experiments/k1695/k1695_results.json .samples.inception_aware.summary
\multicolumn{2}{@{}l}{Average (inception-aware)} & 0.250 & $-$63.1 & 0.206 & $-$35.6 & $-$0.044 & 27.5 \\
\midrule
\multicolumn{8}{@{}l}{\textit{Formal inference (13-market common sample, $N = 3{,}557$ shared dates)}} \\
% source: experiments/k1695/k1695_results.json .inference.primary
\multicolumn{3}{@{}l}{Common-sample average $\Delta$MDD:} & \multicolumn{5}{l}{12.6 pp; joint stationary-bootstrap 90\% CI $[4.2,\ 19.3]$ pp; $\Pr(\le 0) = 0.0006$} \\
\midrule
\multicolumn{8}{@{}l}{\textit{Cross-sectional predictors of $\Delta$MDD (descriptive)}} \\
% source: experiments/k1695/k1695_results.json .samples.inception_aware.summary.vix_sensitivity_vs_delta_mdd
\multicolumn{3}{@{}l}{VIX Sensitivity vs.\ $\Delta$MDD:} & \multicolumn{5}{l}{$r = -0.817$ ($p < 0.001$), $\rho = -0.775$ ($p = 0.002$)} \\
\multicolumn{3}{@{}l}{GJR $\gamma$ vs.\ $\Delta$Sharpe:} & \multicolumn{5}{l}{\emph{Removed in v3:} replication did not reproduce the originally reported Spearman $\rho = 0.830$ (canonical: $\rho = 0.187$, NS); see forensic note in Section~\ref{sec:discussion}.} \\
\bottomrule
\end{tabular}
\begin{tablenotes}
\small
\item \textit{Notes:} Inception-aware full-sample results for 13 international equity ETFs (most from January 2007; INDA from February 2012, MCHI from April 2011; all through March 2026), computed from a pinned data snapshot (\texttt{auto\_adjust=False} with explicit distribution reinvestment; experiment K1695). VT applies the prior calendar month-end 12/VIX weight, rebalanced monthly, with 10 bps one-way turnover costs; Sharpe ratios use a daily prior-day \texttt{\^{}IRX} risk-free proxy. VIX Sensitivity is the correlation between daily asset returns and daily VIX changes. $\Delta$MDD is the reduction in maximum drawdown (positive = improvement); per-market positive $\Delta$MDD is descriptive, not individual significance --- formal inference uses the joint circular stationary bootstrap (mean block 252 days) on the common sample, resampling all 26 BH/VT return vectors on shared date indices. Developed markets average $\Delta$MDD = 31.3 pp; emerging markets 23.0 pp. Only 1 of 13 markets (Japan) shows a Sharpe improvement; the average $\Delta$Sharpe of $-$0.044 is the insurance premium.
\end{tablenotes}
\end{threeparttable}
\end{table}

Figure~\ref{fig:cross_asset} presents the cross-sectional relationship between Sharpe ratio change and MDD improvement. Twelve of the 13 markets fall in the ``insurance quadrant'' (negative $\Delta$Sharpe, positive $\Delta$MDD), confirming that VT functions as drawdown insurance rather than alpha generation. The developed markets (blue circles) cluster at higher MDD improvement values (average 31.3~pp) than emerging markets (red squares, average 23.0~pp), reflecting tighter synchronization with US equity conditions. Brazil (EWZ) is a notable outlier with the smallest MDD improvement (9.9~pp), consistent with its idiosyncratic risk sources that are less responsive to the US VIX signal. The cross-sectional correlation between VIX sensitivity and MDD protection ($r = -0.817$, $p < 0.001$; descriptive) is consistent with an insurance-pricing interpretation.

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{figures/fig2_cross_asset_scatter.pdf}
\caption{Cross-Asset VT: Sharpe Ratio Change vs.\ MDD Improvement for 13 International Markets. Each point represents a country ETF (inception-aware sample, pinned snapshot; experiment K1695). The $x$-axis shows the change in Sharpe ratio from applying 12/VIX VT relative to buy-and-hold; the $y$-axis shows the improvement in maximum drawdown (percentage points). Blue circles denote developed markets ($N = 7$); red squares denote emerging markets ($N = 6$). Dotted lines indicate cross-sectional averages ($\Delta$Sharpe $= -0.044$; $\Delta$MDD $= 27.5$~pp). All 13 markets see positive MDD improvement (common-sample joint-bootstrap 90\% CI for the average: $[4.2, 19.3]$~pp), while only 1 of 13 shows a Sharpe improvement, consistent with the insurance pricing interpretation. Data from Table~\ref{tab:international}.}
...
Sixth, the international equity universe (13 markets in Table~\ref{tab:international}) is now covered by a joint circular stationary bootstrap on the 13-market common sample, whose 90\% CI for the average $\Delta$MDD, $[4.2, 19.3]$~pp, excludes zero; a remaining limitation is that this inference is confined to the post-2012 common window (which excludes the 2008--2009 crisis for most markets), so inception-aware per-market improvements are reported as descriptive statistics only.
