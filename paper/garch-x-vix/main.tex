...
The A4f specification achieves Harvey-significant improvements for three of five assets: SPY ($t = 4.03$), QQQ ($t = 3.71$), and GLD with GVZ ($t = 3.17$). The model fails to reach significance for EEM ($t = -2.47$) and 0050.TW ($t = -1.44$), though the direction of improvement is correct in both cases.
