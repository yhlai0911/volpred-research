...
\begin{tablenotes}
\footnotesize
\item A4f specification: $\tau_t = \theta_0 + \theta_1 \mathrm{VIX}_{t-1}^2$, free $\omega_g$, Student-$t$ innovations; OOS window $W=2{,}000$, refit every 63 days. DM test uses HAC-robust standard errors (Newey--West, lag~$=12$). For the primary full-OOS DM result ($t = 4.03$, $n = 1{,}825$), see Table~\ref{tab:main_results}.
