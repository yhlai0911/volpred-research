...
\begin{tablenotes}
\footnotesize
\item DM $t$: negative values indicate A4f has lower (better) QLIKE than GJR. Harvey significance: $|t| > 3.0$. OOS: 2019--2026. For GLD, A4f uses GVZ: $\tau_t = \theta_0 + \theta_1 \mathrm{GVZ}_{t-1}^2$. STOXX50E and FEZ use US VIX (not VSTOXX), which suffices due to global fear synchronization.
