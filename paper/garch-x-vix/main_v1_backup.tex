...
% ─── Title ───────────────────────────────────────────────────
\title{Multiplicative GARCH-X with VIX: Daily Source Decomposition Outperforms GARCH-MIDAS for Volatility Forecasting and Risk Management\thanks{All errors are my own. Data and replication code are available upon request.}}
