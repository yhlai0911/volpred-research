...
exec >> /Users/yhlai0911/volpred-research/storage/logs/cron/collect_us.log 2>&1
...
_start=$SECONDS
cron_emit_start "collect_us"
/opt/homebrew/bin/uv run python scripts/collect_us_data.py
_ec=$?
cron_emit_exit "collect_us" "$_ec" "$_start"
exit "$_ec"
