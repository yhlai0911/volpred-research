...
2. **長文裁切法**：先寫 800-1000 字再人工裁到 300-400 字 — **僅適用 ≤500 字目標短文**（FB hook / push / TL;DR），**feed 正文不適用**（正文下限 general 1500+/research 2000+ 由 publisher gate enforce；此限定原存於 references/prompt-templates.md:53，2026-07-02 補回主文 — 主文遺失此限定曾導致全部文章被壓縮漏斗腰斬，見 error_log）
3. **資訊密度**：每句必含新資訊，禁迴圈
