---
title: "把五分鐘資料切得更細，預測真的會更準嗎？台指期給了一個保守答案"
audience: general
status: draft
phase: research
tags:
...
experiment_refs:
  - K1582
image_url: experiments/k1582/figures/k1582_lazypack_3_results.png
description: "高頻資料能拆出更多細節，但台指期日盤實測顯示，修正版模型只帶來方向性改善，還不到可宣稱穩定勝出的程度。"
---
...
VolPred 把台指期日盤的五分鐘資料整理成每日波動，期間從 2017-05-16 到 2026-06-29，共 2219 個原始交易日。正式可判斷的樣本外預測有 1697 筆。模型比較很單純：一個基本版，只看過去一天、一週、一個月的波動；兩個修正版，額外把每一天波動估計的噪音、上漲下跌分解、跳動成分放進去。
...
![懶人包：高頻資料預測要先過三關](experiments/k1582/figures/k1582_lazypack_1_framework.png)

![懶人包：三個市場只有台指期樣本足夠](experiments/k1582/figures/k1582_lazypack_2_sample_gate.png)

![懶人包：台指期修正版有方向性改善但還不到勝利](experiments/k1582/figures/k1582_lazypack_3_results.png)
