---
title: "市場走得很毛躁，不代表複雜模型比較準：1,097 次隔日預測的教訓"
audience: general
status: draft
phase: research
description: "SPY、QQQ 與黃金的日波動都很粗糙；放進隔日預測後，簡單 HAR 的誤差仍比兩個粗糙度近似模型低約四分之一。"
tags:
  - 波動率預測
  - SPY
  - HAR
...
![三種模型的隔日波動預測損失](storage/drafts/assets/k1386_general_companion/k1386_qlike_comparison.png)
...
![三個資產的日波動粗糙度估計](storage/drafts/assets/k1386_general_companion/k1386_hurst_estimates.png)
