---
title: "多加一個恐慌指標，波動預測竟有三天變成負數"
audience: general
status: draft
phase: robustness
description: "同一批 1,852 個交易日裡，多放一個市場恐慌指標的模型反而出現三筆不合理預測。這次更正說明排名、穩定性與研究流程要怎麼一起看。"
tags:
  - 波動率預測
  - VIX
  - 模型比較
...
![三個穩定模型的平均罰分與主要比較結果](experiments/k1379/k1379_general_article_chart.png)

*圖一：左側比較三個穩定做法的平均罰分，右側顯示兩組主要差距都跨過嚴格門檻。加入市場恐慌指標的版本因三筆非正預測，不列入經濟幅度排名。*

![不同相鄰日設定下，主要模型比較是否改變](experiments/k1379/k1379_hac_lag_sensitivity.png)
