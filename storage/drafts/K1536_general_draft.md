...
![全樣本每日平均差與 95% 信賴區間](assets/k1536_general_unconditional_gap.png)

| 風險口徑 | 每日平均差（農林 減 控制） | HAC t 值 | p 值 | 95% 信賴區間 |
|---|---|---|---|---|
...
![六次事件的事件前後波動率變化](assets/k1536_general_event_windows.png)

| 事件研究指標 | 估計值 | 95% 信賴區間 | p 值 |
|---|---|---|---|
