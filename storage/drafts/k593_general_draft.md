...
把每段期間最佳視窗加總起來看：W=252 在兩個極平靜期（2012–13、2016–17）勝出；W=504 在中等波動與危機後復甦期（2020–21、2023–24）勝出；W=2000 只在油價崩跌的 2014–15 拔得頭籌；W=1000 從頭到尾都不是任何一段的冠軍。把五段名次平均起來，W=252 與 W=504 並列第一（皆 2.2 名），W=1000 居中（2.6），W=2000 墊底（3.0）。
