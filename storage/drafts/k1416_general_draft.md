...
前一版 Paper 3 的結果裡，`TW0050` 和日本 `N225` 這一組，是十組跨市場配對裡唯一一個真的跑出明顯優勢的案例。問題也正出在這裡：**如果全場只有它贏，會不會只是剛好挑到一個對它有利的樣本起點？**
...
這對 Paper 3 很重要，因為原本最容易被挑戰的地方，就是「唯一顯著那一組會不會只是樣本運氣」。現在至少在起點敏感度這一關，這個質疑沒有被數據支持。
