...
status: published
title: 「AI 瓶頸轉電力」的口號很響，但波動率還沒買單
tags: AI, 電力, 公用事業, 波動率, 橫斷面離散度, 板塊定價
description: 市場都在講「AI 瓶頸從晶片轉向電力」，但把已實現波動率攤開來看，板塊層級根本還沒重定價：公用事業 ETF 波動率只有 15.6%、跟一年中位沒差別，真正翻倍到 61% 的還是半導體。低波動率不是風險低，而是個股離散度被平均掉——GEV 今年 +57%、CEG 卻 −30%。真正的訊號在橫斷面離散度，不在板塊 vol。
data_sources:
  - yfinance 每日收盤價，2024-09-01 至 2026-07-13/14（XLU/XLE/SMH/XLK/SPY/VST/CEG/GEV）
  - 波動率 = 20 交易日對數報酬標準差年化（×√252）
figures:
  - storage/drafts/assets/trending_ai_power_vol_20260715.png
  - storage/drafts/assets/trending_ai_power_vol_ts_20260715.png
---
...
![板塊 vs 個股波動率對比：只有半導體波動率翻倍，公用事業仍在低位，同樣掛 AI 電力的個股命運天差地別](storage/drafts/assets/trending_ai_power_vol_20260715.png)

## ETF 的波動率會騙人

![過去一年 SMH、電力籃子與 XLU 的滾動已實現波動率：半導體一路衝高，公用事業始終貼地](storage/drafts/assets/trending_ai_power_vol_ts_20260715.png)
...
![口號很響，板塊卻沒動：半導體波動率翻倍，公用事業仍在低位](storage/drafts/assets/trending_ai_power_vol_20260715_lazypack/1_concept.png)

![板塊看不出的東西，去看橫斷面離散度](storage/drafts/assets/trending_ai_power_vol_20260715_lazypack/2_method.png)

![同樣掛 AI 電力，個股命運天差地別](storage/drafts/assets/trending_ai_power_vol_20260715_lazypack/3_results.png)
