...
tags: ["一般讀者", "波動率目標", "日曆效應", "SPY", "風險管理", "投資策略", "研究誠實"]
phase: correction
update_summary: "K547b shift(1) 校驗完成：VIX timing 改為 t-1 日收盤後，Daily VT Sharpe 由 1.666 修正為 0.689（-58.7%）；所有 OOS 子期間數字同步修正；核心結論（ToM overlay 顯著拖累 VT 績效）不變。移除『待後續校驗』備注，代以本次正式更正紀錄。"
---

# 「月底翻盤效應」還活著嗎？把日曆異常疊在波動率目標策略上的失敗實錄

![K547 月底效應在現代 SPY 已死](https://qxhfgdfzazwpkdgesavm.supabase.co/storage/v1/object/public/article-images/k547_tom_anomaly_dead.png)
...
![K547 vs K547b：VIX Timing 修正前後 Sharpe 比較](https://qxhfgdfzazwpkdgesavm.supabase.co/storage/v1/object/public/article-images/k547b_sharpe_comparison.png)
...
- 對照文獻：
  ...
  - Harvey, Campbell R.; Liu, Yan; Zhu, Heqing (2016). "… and the Cross-Section of Expected Returns." *Review of Financial Studies*, 29(1), 5–68.
