...
description: "把散戶最常用的六面向框架（經營/財務/市場/籌碼/技術/心理）老實跑在雷虎、漢翔、亞航、長榮航太、中光電、龍德造船六檔龍頭上。技術面六檔全站上月線季線年線、籌碼面法人 60 天買走雷虎 11.9% 股本；但雷虎與中光電的本業是虧的，四檔營收年增率不到 5%。最會賺錢的兩家，賺的不是無人機的錢。"
audience: general
status: draft
...
（本益比一律用 2026-07-11 收盤價除以每股盈餘計算，固定在查核日，不是會隨盤中跳動的即時值。）
...
雷虎在最左上角：本業虧 2.6%，本益比 398 倍，股價淨值比 17.9 倍，而它的股東權益報酬率只有 4.5%。用接近 18 倍的淨值價格，買一家用自有資本一年只能生出 4.5% 的公司。
...
波動這一側更整齊。六檔的年化波動率落在 43% 到 66%，全部高於加權指數的 23.4%。一年之內每一檔都經歷過 33% 到 50% 的最大回撤，同期間指數的最大回撤是 10%。
...
而龍德造船的獲利來自造軍艦。它已交付的無人水面載具是兩艘。長榮航太的 19.8% 股東權益報酬率來自飛機維修這門老生意，它在無人機上的最高進度是「取得供應商資格」。

換句話說，這六檔裡最會賺錢的兩家，賺的都不是無人機的錢；而最像純無人機股的雷虎，本業還在虧。

純度和獲利，目前是反向的。

## 方法、限制與免責

**資料來源**：股價取自 yfinance 還原除權息收盤價；營收、營業利益率、淨利、股東權益報酬率為公司年報揭露值。三大法人買賣超取自證交所 T86「三大法人買賣超日報」，累計區間 2026-04-15 至 2026-07-09 共 60 個交易日（60 天全部抓取成功，無失敗日、無欄位解析失敗，紀錄在證據檔裡）。價格窗口 2025-06-30 至 2026-07-11。查核日 2026-07-13。

**限制**：
1. 中光電為上櫃股，證交所日報不含；櫃買中心公開資料只提供最近一日，無法建立同口徑的 60 日累計，該格留白。
2. 本益比與股價淨值比是用 2026-07-11 收盤價除以每股盈餘、每股淨值算出來的，固定在查核日。市面上看到的即時本益比會隨盤中股價跳動，數字會和本文不同，那不是矛盾，是口徑不同。
