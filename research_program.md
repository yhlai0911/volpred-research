...
- **Phase K 統合（50+ 實驗）**：(1) ★★★ QLIKE ceiling 18x confirmed (2) ★★ 50/50 beats ALL optimization (3) ★★ Options surface + CSVD 被 VIX 吸收 (4) ★★ Dynamic target 數學上不改變 Sharpe (5) ★ Multi-step ceiling holds, R² peak at h=5 (6) ML 5 次失敗 (LSTM/GBM/GARCH-LSTM/XGBoost/ICL) (7) Execution alpha 存在但不可獲利 (8) VIX sufficient statistic 16x (behavioral vol dispersion also null)
