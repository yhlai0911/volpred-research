...
| **P10** | **crypto-fear-channel** | ✅ **reproduce gate 100% (7/7)** + Claude pre-body review 歸檔 + body_v0_intro.tex H1+H3 fixes + **2026-04-27 主線程補 4/6 Codex gaps**: ✓ claim-to-JSON / ✓ k1025.py read / 仍未知 lit review 15-20 DOIs / ✓ outline reconcile (K639 lag 2-10 + K746b reverse-direction attribution fix) / ✓ reproduce scaffold / ✓ data snapshot (`paper/crypto-fear-channel/data/spy_btc_usd_vix_2015-2026.csv` 4116 rows, auto_adjust=False) | body drafting（Sec 2-6 主體）剩 lit review 15-20 DOIs gap + 主線程接手 §2-§6 寫作（per p10_status_2026_04_27.md，2-3 週主線程 effort） |
