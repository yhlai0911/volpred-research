...
- [ ] **天然資源實質資產籃（農地 REIT LAND/FPI、林地 WY/RYN、水資源 ETF PHO/CGW/FIW）的通膨避險與氣候風險 vol 因子** — yfinance LAND/FPI/WY/RYN/PHO/CGW/FIW + CPI/PPI surprise、breakeven inflation、SPY，檢定 inflation-shock 與 drought/climate event window 下 RV、downside semivariance、與大盤相關性是否真正較低；與既有 listed-infrastructure（PAVE/IFRA/IGF/GRID）題正交，這裡是農地/林地/水資源天然資產（來源：JPM/FAJ 2025-26 機構 real-assets 配置興趣升溫，農地/林地/水權作抗通膨與氣候避險工具）。
