...
- [ ] **Data-driven VC screening shock 對 public innovation-stock volatility 的融資閘門效應** — 用 RFS data-driven investor adoption source 只作機制；實證端用 SEC S-1 / IPO calendar、VC-backed public-company cohort、listed innovation ETF（ARKK/IPO/IGV/SOXX/AIQ）與 public funding/news counts 建粗 proxy，檢定 algorithmic-screening / AI-funding attention shock 是否領先 young-growth basket RV、IPO basket downside variance 與 innovation-sector dispersion；若免費 VC deal data 不足，實驗必須停在 public-proxy diagnostic。與 AI mega-cap HHI / AI capex 題正交—— 這裡是 private financing gatekeeping 對 public innovation beta 的外溢（來源：RFS 2026 "Data-Driven Investors" + CFA Institute 2025 "AI in Asset Management"；投資流程自動化成資本配置主題）。
