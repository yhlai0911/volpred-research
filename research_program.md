...
- [ ] **選擇權競價的 price-improvement／liquidity benefit 是否在壓力期崩解** — 用作者公開 replication sample 對接事前已知 VIX，預註冊競價×高波動 interaction，檢定 execution quality 與 dispersion；若公開樣本不含完整 OPRA 欄位，只稱 replication-sample stress diagnostic。
