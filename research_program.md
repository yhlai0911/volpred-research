...
- **Phase K 統合（54+ 實驗）**：(1) ★★★ QLIKE ceiling 18x confirmed (2) ★★ 50/50 beats ALL optimization (3) ★★ Options/CSVD/Climate/MOVE/Liquidity 全被 VIX 吸收 (4) ★★ Dynamic target 不改變 Sharpe (5) ★ Multi-step ceiling holds (6) ML 5 次失敗 (7) VIX sufficient 21x (8) VIX→MOVE causality (非反向) (9) ★ Liquidity persistence structural truth but forecast-irrelevant
