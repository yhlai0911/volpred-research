...
- [ ] **跨交易所 crypto arbitrage spread 作為短期 RV 訊號** — 用 CCXT / Binance-Coinbase-Kraken public API 抓 BTC/ETH midprice dispersion、quoted spread 與 arbitrage gap，建立 exchange-fragmentation stress 指標，`signal.shift(1)` 檢定 t+1/t+5 RV、left-tail 與 liquidity drought；與 stablecoin / perp funding / crypto vol-of-vol 題正交——這裡是 market microstructure fragmentation（來源：SSRN 2024-26 crypto exchange arbitrage / DeFi microstructure trend）。
