...
### 期刊主題挖掘 batch（2026-07-07；research_backlog all-covered fallback → hourly-20 派 general-purpose agent 掃 JPM/FAJ/JFM/JFEC/JBES/JoE/AER 2025-26 趨勢層級補料。刻意鎖 forecast-eval 方法學護城河（fluctuation test / Mincer-Zarnowitz / realized-cov / HARQ-contrarian）+ 淨成本 VT + realized-dispersion / VRP 時段結構，避開兩個飽和 NULL 弧。）
