...
- [ ] **加州野火/西部乾旱物理氣候風險對電力公用事業負債股與農業 ETF 的 dose-response** — NOAA/Cal Fire 公開野火事件資料庫 + US Drought Monitor（USDA/NOAA 免費）+ yfinance PCG/EIX/SRE（西岸電力公司）、DBA/CORN/WEAT（農業），檢定野火宣告/乾旱等級升高後 t+1..t+22 idiosyncratic RV、left-tail 是否對高曝險公司單調放大；與既有東岸颶風/cat bond 再保險題正交——這裡是西岸野火/乾旱對電力負債公司與農業（來源：QJE/AER/JPE 2025-26 physical climate risk 對企業資產負債表重定價研究熱潮）。
