...
- [ ] **台股漲跌幅限制 magnet effect 與 2015 年 7%→10% 放寬自然實驗：觸限/近限日的次日 vol 動態** — TWSE 免費日資料（全市場個股）+ 本機 TAIFEX tick，識別觸限/收在限價 ±1% 內的股票-日，檢定次日 RV continuation vs reversal，2015-06-01 放寬作 DiD（J. Empirical Finance magnet 經典 + PBFJ 2019 price-limit-change 線；台灣是文獻 canonical 市場，資料主場優勢）。新弧：交易制度約束→vol 動態，backlog 無此類。
