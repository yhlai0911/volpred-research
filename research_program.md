...
- [ ] **電力現貨/日前市場價格 RV 直接建模（非電力股 proxy），再生能源滲透率作波動驅動** — EIA Electricity Data Browser 公開日前/即時電力價格（免費 API key 註冊，非付費 blocker）+ 區域再生能源滲透率(wind/solar share)，直接對電力現貨價格建 HAR-RV，檢定高滲透日是否有更高 RV/left-tail；與既有 PJM 容量拍賣 event-window 公用事業股 vol（line 491）與 K1508 資料中心電力需求 NULL 正交——那些用電力股當 proxy，這裡直接對電力現貨價格本身建模（來源：Journal of Futures Markets / Journal of Commodity Markets 2025-26 renewable intermittency → power price vol 研究興起）。
