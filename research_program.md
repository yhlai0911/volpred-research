...
- [ ] **美國最小跳動單位試驗的 pre-spread 波動異質性** — 用官方隨機分組與市場品質表，按事前 spread `<10¢`／`>15¢` 固定分層，估 1¢→5¢ 對 small-cap RV、區間與流動性的 DiD／事件研究，配 randomization inference、placebo 與 Holm 檢定；不得事後改分箱。
