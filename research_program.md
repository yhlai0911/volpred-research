...
|---|---|---|---|
| **P5** | **vt-crowding-abm** | 🟡 **v3 REFRAME COMPLETE + v3 REVIEW DONE (2026-04-28)** — v3 main.tex 23p / 0 errors / reproduce GREEN 47/47 100%；v3 paper-review-cycle round (2026-04-28): academic 4.2★/5 (1 SEVERE + 3 MAJOR + 7 MED + 6 MINOR), citation 0 MAJOR / 1 MED-blocking / 5 MINOR. **Stage stays at `review`** (NOT promoted)；v4 必修：S1 §2.4 stale OAT description 矛盾 §4.5 K1262b design / M1 Table 2 vs Table 4 cell1 baseline reconciliation footnote / M2 Abstract sim-count cross-product misleading / harvey2018 DOI / v2 carry-over batch (perchet/kyle/cole/MC SE/kurtosis CI/fire-sale/Welch/`\and`)；reframe quality strong (family-level argument intellectually defensible + 17/17 robustness checks + §5.3 +2 limitations honest). knowledge entries: f1d85a74 (K1261) + f3b9edd4 (K1262) + 81ebfe54 (K1262b). reviews 歸檔 `paper/vt-crowding-abm/review_history/v3/{academic,citation}_review_report.md` + README | v4 修復（paper-update skill, ~2-3 hr）→ v4 round → 升 ready stage；submission target FRL (~85% acceptance post v4 per academic_review_report) |
