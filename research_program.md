...
- [ ] **Bond ETF AP-concentration 壓力代理：authorized participant 集中度高的 ETF 是否在 stress days 有更大 NAV deviation 與 RV gap** — yfinance bond ETF 日 OHLCV（AGG/BND/LQD/HYG/MUB/EMB/TLT/IEF）+ 公開 13F primary dealer holdings proxy（用 top-3 holder 報告 share 近似 AP concentration），檢定高集中 ETF 在 VIX>25 或 MOVE>120 stress days 的 premium-discount proxy 是否擴張、且 5d forward RV 是否更高；與 line 1156 same-index ETF liquidity clientele 正交，這裡是 AP-concentration channel（來源：BIS 2025 anatomy of bond ETF arbitrage + JBF 2025 AP regulatory constraints dash-for-cash）
