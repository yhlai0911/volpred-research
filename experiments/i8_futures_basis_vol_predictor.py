...
Output: experiments/i8_futures_basis_results.json
"""
...
with open('experiments/i8_futures_basis_results.json', 'w') as f:
    json.dump(results, f, indent=2, ensure_ascii=False, default=str)

print("Results saved to experiments/i8_futures_basis_results.json")
