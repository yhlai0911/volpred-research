"""
K1696 — Term-spread realized volatility as leading indicator
=============================================================
...
Outputs
-------
experiments/K1696/K1696_results.json
experiments/K1696/fig_tsv_timeseries.png
experiments/K1696/fig_dm_heatmap.png
...
def plot_tsv_timeseries(features: pd.DataFrame, prices: pd.DataFrame,
    ...
    axes[0].set_title("K1696 — Term-spread realised volatility (FRED 10y-2y)")
...
def plot_dm_heatmap(oos_all: Dict, out_path: Path) -> None:
    ...
    ax.set_title("K1696 — HLN-DM t-stats on out-of-sample QLIKE\n"
...
def main() -> Dict:
    ...
    out_path = EXP_DIR / "K1696_results.json"
