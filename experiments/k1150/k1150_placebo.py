#!/usr/bin/env python3
"""
K1150 placebo test — within-stock permutation of EAV (JP)
==========================================================
Aligned with K1145 and K1147 placebo protocol.
...
def main():
    ...
    print('=== K1150 placebo: within-stock permutation of EAV (JP) ===')
    ...
    out = {
        'experiment_id': 'K1150_placebo',
        'description': 'Within-stock EAV permutation placebo for JP panel; refit pooled MLE',
    ...
    out_path = SCRIPT_DIR / 'k1150_placebo_results.json'
