...
Output: experiments/i9_proper_hedging_results.json
"""
...
with open('experiments/i9_proper_hedging_results.json', 'w') as f:
    json.dump(output, f, indent=2, ensure_ascii=False, default=str)

print(f"\n{'='*75}")
print("Results saved to experiments/i9_proper_hedging_results.json")
print(f"{'='*75}")
