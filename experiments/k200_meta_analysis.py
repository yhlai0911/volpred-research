...
Usage:
    cd <project_root>
    uv run python experiments/k200_meta_analysis.py
"""
...
EXPERIMENTS_PATH = ROOT / "storage" / "memory" / "experiments.json"
OUTPUT_PATH = ROOT / "experiments" / "k200_meta_analysis_results.json"
