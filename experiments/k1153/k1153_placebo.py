#!/usr/bin/env python3
"""
K1153 placebo test — within-stock permutation of EAV (EU)
==========================================================
Aligned with K1145 / K1147 / K1150 placebo protocol.
...
and observed θ_EAV should be far in the tail.
"""
...
def main():
    ...
    print('=== K1153 placebo: within-stock permutation of EAV (EU) ===')
    ...
    out = {
        'experiment_id': 'K1153_placebo',
        'description': 'Within-stock EAV permutation placebo for EU panel; refit pooled MLE',
    ...
    out_path = SCRIPT_DIR / 'k1153_placebo_results.json'
