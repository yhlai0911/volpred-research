...
## 方法
- **數據**: SPY 2005-2026, VIX (yfinance), n=5346, OOS n=1825
...
- **測試**:
  ...
  3. OOS R² (Campbell & Thompson 2008, expanding window; h-step fits only use training pairs whose target date has already realized)
...
| h=5     | -0.033    | -1.321     | -1.241        |
| h=10    | -0.068    | -3.987     | -3.859        |
| h=22    | -0.011    | -0.011     | -0.018        |
