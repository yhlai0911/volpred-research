...
Output: experiments/i3_cross_asset_futures_results.json
"""
...
with open('experiments/i3_cross_asset_futures_results.json', 'w') as f:
    json.dump(results, f, indent=2, ensure_ascii=False, default=str)

print("Results saved to experiments/i3_cross_asset_futures_results.json")
