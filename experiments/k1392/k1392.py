#!/usr/bin/env python3
"""
K1392: Leave-COVID-out DM Test for A4f vs GJR (Paper 9 garch-x-vix C1 fix)
===========================================================================
Motivation:
...
Date: 2026-05-22
K1391 difference: truncate OOS end to 2026-04-07 (paper's stated end date)
Seed: 42
"""
...
RESULTS_PATH = os.path.join(SCRIPT_DIR, 'k1392_results.json')
...
OOS_END = '2026-04-07'  # Truncate to paper's stated OOS end (K988 period)
...
results = {
    ...
    'configuration': {
        ...
        'seed': 42,
        'note': 'Truncated OOS to match paper stated OOS end (2026-04-07, n≈1825); K1391 extended to May 2026',
    },
    'sample_sizes': {
    ...
    'metadata': {
        ...
        'review_round': 'v3',
        'reviewer': 'K1392 dedicated experiment',
