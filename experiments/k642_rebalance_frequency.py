...
def main():
    ...
    plt.tight_layout()
    plot_path = Path(MAIN_REPO) / "experiments" / "k642_rebalance_frequency.png"
    ...
    # Save
    results_path = Path(MAIN_REPO) / "experiments" / "k642_results.json"
    ...
    P(f"\n  Files saved:")
    P(f"    Script: experiments/k642_rebalance_frequency.py")
    P(f"    Results: experiments/k642_results.json")
    P(f"    Plot: experiments/k642_rebalance_frequency.png")
