...
Output: experiments/i6/i6_futures_vs_vt_cost_results.json
"""
...
with open('experiments/i6/i6_futures_vs_vt_cost_results.json', 'w') as f:
    json.dump(results, f, indent=2, ensure_ascii=False, default=str)

print("Results saved to experiments/i6/i6_futures_vs_vt_cost_results.json")
