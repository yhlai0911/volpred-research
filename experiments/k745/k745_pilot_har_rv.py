...
Usage:
    uv run python experiments/k745/k745_pilot_har_rv.py
"""
...
def main():
    ...
    results_path = EXPERIMENT_DIR / "k745_pilot_har_rv_results.json"
    with open(results_path, "w") as f:
        json.dump(output, f, indent=2, default=str)
    print(f"  Results: {results_path}")

    forecasts_path = EXPERIMENT_DIR / "k745_forecasts.json"
